...
/**
 * Level4mentor Component
 *
 * PURPOSE: Main workspace page for Mentor's Level 4 interface.
 *
 * RESTRICTION LOGIC:
 *   - Checks if the logged-in mentor has any active project groups assigned at Level 4.
